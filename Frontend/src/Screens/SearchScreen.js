...
import { prices, ratings } from "../utilis.js";
...
export default function SearchScreen(props) {
	...
	}, [category, dispatch, name, min, max, order, rating]);
	...
	return (
		<div>
			<div className="row">
				{loading ? <LoadingBox></LoadingBox> : error ? <MessageBox variant="danger">{error}</MessageBox> : <div>{products.length} Results</div>}{" "}
				<div>
					Sort by{" "}
					<select
						value={order}
